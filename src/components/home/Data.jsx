...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Tejasree Dakoji
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Web Designer & Data analytics enthusiast</h3>
        <p className="home__description">Welcome to my portfolio! I'm Tejasree, a passionate web developer and data analytics enthusiast with a drive to create innovative solutions that drive business growth. With a strong foundation in web development and a keen interest in data analysis, I'm dedicated to helping organizations make data-driven decisions and build scalable, user-friendly applications.</p>
